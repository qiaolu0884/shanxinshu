	...
	*/
    ...
    InitDate.prototype = {
        ...
        setHtml:function(opts, self) {
            ...
            var dateymList = !isformat ? '<div class="jedatetopym" style="display: none;">' + '<ul class="ymdropul"></ul><p><span class="jedateymchle icon-left1"></span><span class="jedateymchri icon-right1"></span><span class="jedateymchok">关闭</span></p>' + "</div>" :'<ul class="jedaym"></ul>';
        ...
        orien:function(obj, self, pos) {
            ...
            obj.style.left = rect.left + (pos ? 0 :jeDt.scroll(1)) + "px";/*0; */
